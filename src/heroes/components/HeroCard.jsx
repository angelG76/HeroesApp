...
export const HeroCard = ({ id,
  ...
  const CharactersByHero = ({ characters, alter_ego }) => {
    ...
    return <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{characters}</p>
  }
  return (
    ...
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="p-5">
        <div>
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{superhero}</h5>
        </div>
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{alter_ego}</p>

        <CharactersByHero characters={characters} alter_ego={alter_ego} />

        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400"> <small className="text-gray-500">{first_appearance}</small></p>
